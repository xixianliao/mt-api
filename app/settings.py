...
CONFIG_JSON_PATH: str = os.getenv('MT_API_CONFIG', './config.json')
MODELS_ROOT_DIR: str = os.getenv('MODELS_ROOT', './models')
CTRANSLATE_DEVICE: str = ('cuda' if os.getenv('MT_API_DEVICE') == 'gpu' else 'cpu')
TRANSFORMERS_DEVICE: str = (0 if os.getenv('MT_API_DEVICE') == 'gpu' else -1)
